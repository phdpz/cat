...
public class StationDaoImpl extends BaseDaoImpl<Station> implements StationDao{
	...
	protected Class<Station> entityClass = (Class<Station>) GenericsUtils.getSuperClassGenricType(this.getClass());
	//
	protected static String tableName = "Station";
	// 配置组件，方便方法的使用
	/**
	 * @Description 获取记录总数
	 * @return int
	...
	public List<String> getAllSchool(){
		String hql="select distinct s.SSchool from Station as s";
	...
	public List<Station> findByProperty(String propertyName, Object value) throws HibernateException{
		...
		return (List<Station>) this.sessionFactory.getCurrentSession().createQuery(hql).setParameter(0, value).list();
	}
	/**
	...
	public List<Station> findAll(final LinkedHashMap<String, String> orderBy) throws Exception{
		...
		return (List<Station>) this.sessionFactory.getCurrentSession().createQuery("from " + tableName +" o " + buildOrderby(orderBy)).list();
	}
	/**
	...
	public QueryResult<Station> listByPage(final int page,final int size){ 
        ...
        final QueryResult<Station> queryResult = new QueryResult<Station>();
        //获取总记录数
