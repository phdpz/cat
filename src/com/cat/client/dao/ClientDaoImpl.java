...
public class ClientDaoImpl extends BaseDaoImpl<Clientinfo> implements ClientDao{
	...
	protected Class<Clientinfo> entityClass = (Class<Clientinfo>) GenericsUtils.getSuperClassGenricType(this.getClass());
	//
	protected static String tableName = "Clientinfo";
	// 配置组件，方便方法的使用
	/**
	 * @Description 获取记录总数
	 * @return int
	...
	public List<Object[]> findPerInfo(String hql) throws Exception {
		return this.findSomeByHql1(hql);
	}
	...
	public List<Clientinfo> findByProperty(String propertyName, Object value) throws HibernateException{
		...
		return (List<Clientinfo>) this.sessionFactory.getCurrentSession().createQuery(hql).setParameter(0, value).list();
	}
	/**
	...
	public List<Clientinfo> findAll(final LinkedHashMap<String, String> orderBy) throws Exception{
		...
		return (List<Clientinfo>) this.sessionFactory.getCurrentSession().createQuery("from " + tableName +" o " + buildOrderby(orderBy)).list();
	}
	/**
	...
	public QueryResult<Clientinfo> listByPage(final int page,final int size){ 
        ...
        final QueryResult<Clientinfo> queryResult = new QueryResult<Clientinfo>();
        //获取总记录数
