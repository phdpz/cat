...
public class stationChartUtil {
	...
	public static JFreeChart getJFreeChart(Map<String, Object> map){
		...
		if(map.containsKey("num"))
		   chart=ChartFactory.createPieChart("水果销量学校各站点分析", dataset,true,true,false);
		if(map.containsKey("money"))
		   chart=ChartFactory.createPieChart("水果营业额学校各站点分析", dataset,true,true,false);
		setPiePlotNum(chart);
		//设置背景图片
