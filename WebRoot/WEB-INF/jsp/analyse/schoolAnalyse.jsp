	...
	function checkDate()
	  ...
	  function search()
	  {
		  ...
		  var beginDate=document.getElementById("beginDate").value;
			 ...
			 var urlStr = "<%=request.getContextPath()%>/analyse/schoolAnalyseAjax/"+beginDate+"/"+endDate;
				$.ajax({
					method: "GET",
					url: urlStr,
					success:function(data,status,jqXHR){
						...
						th2.innerHTML="下单量"+"<span class='fa fa-caret-up caret-up' onclick='javascript:$.sortTable.sort(\"school\",1,0)'></span>"+
						"<span class='fa fa-caret-down caret-down' onclick='javascript:$.sortTable.sort(&quot;school&quot;,1,1)'></span>";
						var th3 = document.createElement('th');
						th3.innerHTML="下单量比例"+"<span class='fa fa-caret-up caret-up' onclick='javascript:$.sortTable.sort(\"school\",1,0)'></span>"+
						"<span class='fa fa-caret-down caret-down' onclick='javascript:$.sortTable.sort(&quot;school&quot;,1,1)'></span>";
						var th4 = document.createElement('th');
						th4.innerHTML="营业额"+"<span class='fa fa-caret-up caret-up' onclick='javascript:$.sortTable.sort(\"school\",3,0)'></span>"+
						"<span class='fa fa-caret-down caret-down' onclick='javascript:$.sortTable.sort(&quot;school&quot;,3,1)'></span>";
						var th5 = document.createElement('th');
						th5.innerHTML="营业额比例"+"<span class='fa fa-caret-up caret-up' onclick='javascript:$.sortTable.sort(\"school\",3,0)'></span>"+
						"<span class='fa fa-caret-down caret-down' onclick='javascript:$.sortTable.sort(&quot;school&quot;,3,1)'></span>";
						TR.appendChild(th1);
						TR.appendChild(th2);
						TR.appendChild(th3);
						...
						var tb=document.getElementById("school");
			...
			<div class="content">
				...
				<div class="container">
					...
					<ul class="report_nav" id="report_nav">
						...
						<li><a href="<%=request.getContextPath()%>/analyse/schoolAnalyse/2015-08-01/<%=date%>" class="active">学校分析</a></li>
					...
					<div class="panel">
						...
						<div class="panel_body">
							...
							<span class="setSpace">结束时间:</span>
								<input type="date" class="input cls3" id="endDate" value="<%=date%>" max="<%=date%>" onInput="checkDate()"/>
						    ...
						    <table class="table" id="school">
								<thead>
									<tr name="head">
										<th>学校</th>
										<th>下单量
											<span class="fa fa-caret-up caret-up" onclick="javascript:$.sortTable.sort('school',1,0)"></span>
											<span class="fa fa-caret-down caret-down" onclick="javascript:$.sortTable.sort('school',1,1)"></span>
										</th>
										<th>下单量比例
											<span class="fa fa-caret-up caret-up" onclick="javascript:$.sortTable.sort('school',1,0)"></span>
										...
										<th>营业额
											<span class="fa fa-caret-up caret-up" onclick="javascript:$.sortTable.sort('school',3,0)"></span>
											<span class="fa fa-caret-down caret-down" onclick="javascript:$.sortTable.sort('school',3,1)"></span>
										</th>
										<th>营业额比例
											<span class="fa fa-caret-up caret-up" onclick="javascript:$.sortTable.sort('school',3,0)"></span>
								...
								<tbody>
									<c:forEach items="${map.school}" var="item" varStatus="i">
...
<html>
  ...
  %>
    ...
    <br><br><br>
   <font style="font-size:20px;font-weight:bold">学校统计</font> 
   ...
   <br>
   <table border=1 width="800px" id="school">
      <tr>
         <th>学校</th>
         <th>下单量</th>
         <th>下单量比例</th>
